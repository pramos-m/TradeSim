...
export const StateContexts = {
  ...
  reflex___state____state__tradesim___tradesim___state___auth_state____auth_state: createContext(null),
  reflex___state____state__reflex___state____on_load_internal_state: createContext(null),
}
export const EventLoopContext = createContext(null);
export const clientStorage = {"cookies": {"reflex___state____state.tradesim___tradesim___state___auth_state____auth_state.auth_token": {"name": "auth_token", "path": "/", "maxAge": 1800, "sameSite": "lax"}}, "local_storage": {}, "session_storage": {}}
...
export const lastCompiledTimeStamp = "2025-02-25 21:13:47.426768"
...
export function StateProvider({ children }) {
  ...
  const [reflex___state____state__tradesim___tradesim___state___auth_state____auth_state, dispatch_reflex___state____state__tradesim___tradesim___state___auth_state____auth_state] = useReducer(applyDelta, initialState["reflex___state____state.tradesim___tradesim___state___auth_state____auth_state"])
  ...
  const dispatchers = useMemo(() => {
    return {
      ...
      "reflex___state____state.tradesim___tradesim___state___auth_state____auth_state": dispatch_reflex___state____state__tradesim___tradesim___state___auth_state____auth_state,
  ...
  return (
    ...
    <StateContexts.reflex___state____state__tradesim___tradesim___state___auth_state____auth_state.Provider value={ reflex___state____state__tradesim___tradesim___state___auth_state____auth_state }>
    ...
    </StateContexts.reflex___state____state__tradesim___tradesim___state___auth_state____auth_state.Provider>
