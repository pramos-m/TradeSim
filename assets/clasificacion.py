            ...
            rx.vstack(
                ...
                rx.box(
                    rx.vstack(
                        ...
                        rx.vstack(
                            ...
                            spacing="4", width="100%", padding_top="4" # Añadir padding si el header no tiene margin inferior
                        ),
                        align_items="stretch", width="100%",
                    ),
                ...
                rx.cond(
                    ...
                    rx.box( # Contenedor de la sección "Tu Rendimiento Actual"
                        rx.vstack(
                            rx.heading(
                                "Tu Rendimiento Actual", as_="h2", size="6", # Consistente con otros títulos de sección
                            ...
                            rx.box(
                                rx.hstack(
                                    ...
                                    rx.vstack(
                                        ...
                                        rx.text(
                                            ...
                                            color=rx.cond(RankingState.user_position["is_roi_positive"], POSITIVE_COLOR, NEGATIVE_COLOR), # Colores más oscuros
                                            font_weight="semibold", font_size=["md", "lg", "lg"],
                                        ),
                                        align_items="flex-end", spacing="0",
                                    ),
                                    rx.vstack(
                                        ...
                                        rx.text(
                                            ...
                                            color=rx.cond(RankingState.user_position["is_profit_positive"], POSITIVE_COLOR, NEGATIVE_COLOR), # Colores más oscuros
                                            font_weight="semibold", font_size=["md", "lg", "lg"],
                                        ),
                                        align_items="flex-end", spacing="0", margin_left="15px",
                                    ),
                                ...
                                _hover={
                                    ...
                                    "box_shadow": "2xl", # Sombra aún más destacada en hover
                                },
                                transition="all 0.2s ease-out",
                            ),
                            align_items="stretch", width="100%",
                        ),
                        background_color=CARD_BACKGROUND_COLOR, # Fondo blanco para la sección
                ...
                padding_x=["15px", "20px", "30px"], padding_y="40px", # Aumentado padding vertical de la página
