# tradesim/pages/login.py (CORREGIDO FINAL - on_load ELIMINADO)
import reflex as rx
    ...
    return rx.form(
        rx.vstack(
            ...
            rx.vstack(
                ...
                rx.box( rx.text("CONTRASEÑA", font_size="1", font_weight="500", color="black"), rx.input( type_="password", value=AuthState.password, on_change=AuthState.set_password, bg="gray.100", border="0px", size="3", padding="6"), width="100%"),
                spacing="4", width="100%",
            ),
    ...
    return rx.form(
        rx.vstack(
            ...
            rx.vstack(
                ...
                rx.box( rx.text("EMAIL", font_size="1", font_weight="500", color="black"), rx.input( placeholder="ElonMusk@iCloud.com", value=AuthState.email, on_change=AuthState.set_email, bg="gray.100", border="0px", size="3", padding="6"), width="100%"),
                rx.box( rx.text("CONTRASEÑA", font_size="1", font_weight="500", color="black"), rx.input( type_="password", value=AuthState.password, on_change=AuthState.set_password, bg="gray.100", border="0px", size="3", padding="6"), width="100%"),
                rx.box( rx.text("CONFIRMAR CONTRASEÑA", font_size="1", font_weight="500", color="black"), rx.input( type_="password", value=AuthState.confirm_password, on_change=AuthState.set_confirm_password, bg="gray.100", border="0px", size="3", padding="6"), width="100%"),
                spacing="4", width="100%",
            ),
